...
from dashboard.filters import register_filter_callbacks
from dashboard.graph_engine import register_graph_callbacks
from dashboard.router import register_router_callbacks
